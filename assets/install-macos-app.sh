...
echo -e "${CYAN}"
echo "╔═══════════════════════════════════════════════════════════╗"
echo "║   wlwl-ass — macOS Desktop App Installer                 ║"
echo "╚═══════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
if [ "${AUTO_MODE}" = false ]; then
    echo ""
    echo "This will install a desktop app that launches wlwl-ass"
...
log_info "Applying wlwl-ass icon..."
if [ -f "${ICON_PATH}" ]; then
