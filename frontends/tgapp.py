...
if __name__ == '__main__':
    ...
    if not ALLOWED: 
        print('[Telegram] ERROR: bots.telegram.allowed_users is empty or missing. Set it via `python -m launcher.config set bots.telegram.allowed_users \'[123456]\'` to avoid unauthorized access.')
        sys.exit(1)
