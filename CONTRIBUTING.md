# Contributing to wlwl-ass

## Why This File Is Short

wlwl-ass's core is ~3K lines. Every file in this repo will be read by AI agents — potentially thousands of times. Extra words cost real tokens and push useful context out of the window, increasing hallucinations. This document practices what it preaches: **say only what matters.**
...
3. **Borrowing from other projects?** Append an entry to [`ATTRIBUTION.md`](./ATTRIBUTION.md) in the same PR. See its "Update Protocol" section for what triggers a new entry.
...
wlwl-ass evolves through skills. Not all skills belong in the core repo:
...
- [ ] If you copied code/SOPs/prompts/algorithms from another project: `ATTRIBUTION.md` updated
